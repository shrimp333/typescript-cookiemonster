...
let cookieArray = new Array<Cookie>;
...
function init() {
  ...
  const cookieColourDropDown = document.getElementById("cookieSelector");
  cookieColourDropDown.append(new Option("Cookie1", "Cookie1"));

  cookieArray.push(new Cookie("Cookie1"));
  cookieArray.push(new Cookie("Cookie2"));
